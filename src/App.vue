...
const html = `
  ...
  <h2>长歌行</h2>
    ...
    <p>少壮不努力，老大徒伤悲。</p>
  <h2>Image</h2>
  <img src="${img}" alt="sample image" draw="true"/>
  <h3>Bullet List</h3>
    <p>一个无序的列表</p>
    <ul>
        <li>Item 1</li>
